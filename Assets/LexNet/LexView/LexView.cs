...
namespace Lex
{
    ...
    public class LexView : MonoBehaviour
    {
        ...
        public void SetInformation(int viewID, string tag, int ownerID, int creatorID, bool roomview)
        {
            ...
            this.viewType = (roomview) ? ViewType.RoomView : ViewType.PrivateView;
            this.uid = ownerID.ToString();
            if (IsRoomView)
            {
